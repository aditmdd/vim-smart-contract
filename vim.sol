...
contract VIM_FINANCE is Context, IERC20, Ownable {
    ...
    address payable public _vimMarketing =
        payable(address(0x87765D5ca3F60D433c5864e1AA3021e584460a2f));
    ...
    constructor() {
        ...
        _isExcludedFromFee[_vimMarketing] = true;
    ...
    function _takeMarketing(uint256 tMarketing) private {
        uint256 currentRate = _getRate();
        uint256 rMarketing = tMarketing.mul(currentRate);
        _rOwned[_vimMarketing] = _rOwned[_vimMarketing].add(rMarketing);
        if (_isExcluded[_vimMarketing])
            _tOwned[_vimMarketing] = _tOwned[_vimMarketing].add(tMarketing);
    }
